        ...
        <div class="page-content">
            ...
            <div class="cardList mt5">
                <div class="cardItem">
                    ...
                    <div class="fl cardMain" v-show="userCard.user.province==userCard.user.city">{{toNull(userCard.user.province)}}</div>
                ...
                wxApi.userInfo(this.userId).then((res)=>{
                    ...
                    if(res.data!=null){
                        ...
                        wxApi.getTreatments().then((result)=>{
                            ...
                            console.log(this.userCard.treatments,this.userCard.treatments.length);
                        ...
                        if(resData.workTypes.split(',')[0]!=""){
                            for(var k=0;k<resData.workTypes.split(',').length;k++){
                                workTypeList.findIndex(v=>v.code==resData.workTypes.split(',')[k])
                                let obj={
                                    workerType:workTypeList[workTypeList.findIndex(v=>v.code==resData.workTypes.split(',')[k])].value,
                        ...
                        this.userCard.user.avatar  = userInfo.avatar
                        ...
                        let workTypeList = LocalCache.get('workTypeList'),littleBigLabel,workerSizeCode;
                        ...
                        this.$store.state.userCard = this.userCard;
                        console.log("userCard",this.userCard,this.userCard.workTypeList,this.workTypeListExist);
                    }
