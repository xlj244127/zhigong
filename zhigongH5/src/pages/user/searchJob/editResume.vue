        ...
        <div class="page-content">
            ...
            <div class="call">
                <div class="callTop">
                    ...
                    <!--链接未写-->
                    <span class="fr" v-if="uncert"><a href="/company/addIdentityCard">去实名认证</a></span><!--增加实名认证判断-->
                </div>
            ...
            <div class="freeTime exp">
                ...
                <div class="right-box">
                    <input class="right" v-model="contact" type="tel" placeholder="请填写联系方式"/>
                </div>
            </div>
            <div class="cardItem">
                <div class="cardName">
                    <span class="fl">工种标签</span>
                    <span class="fr" @click="addTags" id="pickerDevice02">+ 添加标签</span>
                </div>
            ...
            <div class="freeTime exp">
                ...
                <div class="right-box">
                    <input class="right" v-model="expectTime" @click.stop.prevent="selectTimeAction" id="calendar-defaulttwo" placeholder="请选择预计空闲时间"/>
            ...
            <div class="aside">
                ...
                <div class="over">
                    ...
                    <input type="text" placeholder="Describe yourself" readonly id="picker-tool">
                </div>
            </div>
            <div class="aside">
...
<script>
    ...
    var pickerAddress, pickerAddress2, $$ = Dom7,calendarInline,workTypeDevice, workOrPlace=0;
    let monthNames = ['01', '02', '03', '04', '05', '06', '07', '08' , '09' , '10', '11', '12'];
    let dayNames = ['周日', '周一', '周二', '周三', '周四', '周五', '周六'];
    let dayNamesShort = ['日', '一', '二', '三', '四', '五', '六'];
    import moment from 'moment';
    import {wxApi,userApi,tabulateStatisticsApi,commonApi} from "../../../api";
    ...
    export default {
        ...
        methods: {
            ...
            photoAction(){
                this.$f7.popover('.popover-links', '.fix');
            },
            //图像调调摄像头
            getLicense(){
                ...
                navigator.camera.getPicture((imageData)=>{
                    ...
                    commonApi.uploadCordova(imageData).then((result)=>{
                        ...
                        // alert(that.avatar);
                        $$('.avatar .avat').attr('src', result.data);
                    }, (error)=>{
            ...
            saveInfo(){
                ...
                if(this.salaryType==1){
                    ...
                    console.log('显示',this.lowestSalary, this.highestSalary);
                }
                ...
                console.log('显示2',this.lowestSalary, this.highestSalary, this.salary);
                ...
                //console.log(this.workTypesCode,this.littleBigs);
                this.treatmentCodes = []
                $$('.ret2').each((xls,elm)=>{
                    $$(elm).data('id');
                ...
                console.log(this.editName,this.avatar,this.workingExp,this.provinceId,this.cityId,this.contact,this.remark,this.expectTime,this.districtId,this.detailAddress,this.salaryType,this.salary,this.treatmentCodes.join(','),this.tlementsCode,this.remark);
                wxApi.save(
                    this.editName,
                    this.avatar,
                    this.workingExp,
            ...
            addTags(){
                this.$router.load({url: '/company/selectType/3/:arguments'})
            },
            selectCity(){
                let that = this;
        ...
        mounted(){
            ...
            if(editStatus==1){
                $$('.avatar .avat').attr('src', this.userCard.user.avatar+'?'+Math.random());
                ...
                console.log("salary",this.userCard.user.salary);
...
<style  scoped>
    ...
    .avatarPart .fix{
        position: absolute; right: 14px; bottom: 9px; font-size: 0.55rem; color: #FFFFFF;
    }
    .avatar{
        position: absolute;
        top: 50%;
