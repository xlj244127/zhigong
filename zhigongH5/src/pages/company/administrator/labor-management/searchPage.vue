<template>
    <div data-page="searchPage" class="page navbar-fixed" @page:reinit="back">
        <div class="navbar">
            <div class="navbar-inner">
                ...
                <div class="center sliding">搜索页面</div>
            </div>
        </div>
        <div class="page-content" onload="document.testform.textinput.focus()">
            <div class="ipt">
                <a>
                    <input placeholder="请输入" v-model="name" type="text" autofocus="autofocus"/>
                    <span class="sub" @click="confirmAction">搜索</span>
...
<script>
    ...
    export default {
        ...
        methods:{
            back(){
                wxApi.lookNeedWorker(this.companyId, this.name).then((result)=>{
            ...
            editAction(item){
                this.$router.load({url: '/company/editLaborDemand/'+item.batchNumber});
...
<style scoped>
    ...
    .box .single .cent .right{
        font-size: 0.6rem; color: #666;
    }
    .box .single .cent .right span{
        color: #ccc;
    }
    .box .single .cent2{
        width: 100%; height: 30px; line-height: 30px; display: flex; justify-content: space-between; font-size: 0.6rem; color: #666;
    }
    .box .single .cent2 .left{
        width: 50%;
    }
    .box .single .cent2 .right{
        width: 50%;
    }
    .box .single .cent2 .left span, .right span{
        color: #ccc;
    }
    .box .single .cent3{
        display: flex; background: #f4f8fd; box-sizing: border-box; padding: 6px 0;
    }
    .box .single .cent3 img{
        width: 0.55rem; height: 0.55rem; display: inline-block; transform: translateY(2px); padding-right: 4px;
    }
    .box .single .cent3 .right{
    ...
    .label-switch .checkbox:after{
        width: 13px; height: 13px; left: -7px; top: 0;
    }
