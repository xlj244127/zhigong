<template>
    <div data-page="groupLeaderDetail" class="page navbar-fixed toolbar-fixed">
        <div class="navbar">
            <div class="navbar-inner">
                ...
                <div class="center sliding">班组长详情</div>
            </div>
        </div>
        <!--页面主要类容-->
        <div class="page-content">
            ...
            <div class="main">
                <ul class="aul">
                    ...
                    <li>身份: &nbsp;<span>班组长</span></li>
                    <li>班组:&nbsp; <span>{{groupName}}</span></li>
                </ul>
            </div>
        </div>
    </div>
...
<script>
    ...
    export default {
        ...
        mounted(){
            ...
            //workGroupLeader
            userApi.workGroupLeader(userId).then((result)=>{
                console.log('workGroupLeader',result);
                //this.workGroupLeader = result.data;
                this.groupName = result.data.workGroup.name
