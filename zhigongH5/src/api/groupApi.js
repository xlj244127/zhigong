...
var groupApi = {
    //项目管理员添加工人
    projAddWorker (workType, userId, groupId) {
        return common.postRequest('/workGroup/addWorker',{workType, userId, groupId})
    },

    //添加班组成员列表
    //参数: 工种，用户id
    addGroupMember (workType, littleBig, userId) {
        return common.postRequest('/workGroup/addWorker',{workType, littleBig, userId})
    },
    //班组成员添加到班组
    //参数: 工种，班组长id
