<template>
    <div>
        ...
        <div class="EchartOne">
            ...
            <div class="tst"><span class="t-1">数据说明:</span>  <span class="t-2">平均工时 = 正常考勤工人的工作时长合计 % 正常考勤人数</span></div>
        </div>
    ...
    export default {
        ...
        methods:{
            ...
            jiekoudiaoyong(day){
                ...
                this.averDuration = [];
                this.leixin = [];
                statisticalSummaryApi.monthEcharts(1, this.startTime, projectId).then((result)=>{
...
<style scoped>
    ...
    .EchartOne .box .right{
        text-align: right; padding: 10px 12px 0 0;
    }
    ...
    .EchartOne .type{
        margin: 10px 0;  height: 2rem; display: flex; width: 100%;
    }
    .EchartOne .type .cent{
    ...
    .EchartOne .type .t-1 li{
        width: 75px; height: 2rem; line-height: 2rem; text-align: center; float: left; font-size: 0.6rem; color: #999;
    }
