...
<style scoped>
    ...
    .main .block .aul2{
        height: 7.5rem; line-height: 7.5rem; text-align: center; font-size: 0.7rem; color: #aaa;
    }
</style>