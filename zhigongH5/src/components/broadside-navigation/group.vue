...
<script  type="text/ecmascript-6">
    ...
    import unGroupAttendPic from '../../../static/img/team_punch_sidebar_unselected.png';
    import groupAttendPic from '../../../static/img/team_punch_sidebar_checked.png';
    import unMyGroup from '../../../static/img/team_sidebar_unselected.png';
    import myGroup from '../../../static/img/team_sidebar_checked.png';
        ...
        data(){
            return{
                ...
                list: [
                    ...
                    {name: '班组考勤', img: unGroupAttendPic, img2: groupAttendPic, link: '/user/groupAttend/'},
                    {name: '我的班组', img: unMyGroup, img2: myGroup, link: '/user/myGroup/'},
                    ...
                    {name: '找活干/找工人', img: findJob, img2: findJob, link: '/user/searchJob/'},
                    {name: '审批申请', img: approve, img2: approve, link: '/user/approveApply/'},
                    // {name: '新加页面', img: findJob, img2: findJob, link: '/user/addPage/'},
                ],
                userInfo:{},
                companyName:''
            }
