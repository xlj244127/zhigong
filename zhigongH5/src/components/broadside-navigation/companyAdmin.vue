...
<script  type="text/ecmascript-6">
    ...
    import informationInputPic from '../../../static/img/approved_sidebar_checked.png';
    ...
    import permissionSettingPic from '../../../static/img/quanxian-icon.png';
    ...
    import defaultImg from '../../../static/img/avatar.png';
    import unCompanyInformationPic from '../../../static/img/qiye-icon.png';
    import companyInformationPic from '../../../static/img/qiye-icon.png';
        ...
        data(){
            return{
                ...
                list: [
                    ...
                    {name: '考勤管理', img: unAttendanceManagementPic, img2: attendanceManagementPic, link: '/company/attendManage/'},
                    {name: '项目管理', img: unProjectManagementPic, img2: projectManagementPic, link: '/company/projectManage/'},
                    {name: '信息录入', img: unInformationInputPic, img2: informationInputPic, link: '/company/infoEntering/'},
                    ...
                    {name: '权限设置', img: unPermissionSettingPic, img2: permissionSettingPic, link: '/company/permSetting2/'},
                    {name: '审批管理', img: approve, img2: approve, link: '/company/approve/'},
                    {name: '企业信息', img: unCompanyInformationPic, img2: companyInformationPic, link: '/company/information/'},
                    // {name: '权限设置', img: unPermissionSettingPic, img2: permissionSettingPic, link: '/company/permSetting/'},
                    // {name: '离线模式', img: offLineMode, img2: offLineMode, link: '/company/offLineMode/'}
                    // {name: '离线模式', img: offLineMode, img2: offLineMode, link: '/company/shareRecruit/'}
                ],
                userInfo:{},
                companyName:'',
...
<style scoped type="text/scss">
    ...
    .content-block{
        margin: 0; padding: 0; margin-top: 0.8rem;
    }
    ...
    .content-block .item ul{
        padding: 0; margin: 0; overflow-y: auto; max-height: 478px;
    }
    ...
    .content-block .item2{
        width: 100%; height: 2.5rem; display: flex; box-sizing: border-box; position: fixed; padding-left: 1.25rem;
        left: 0; bottom: 0; border-top: 1px solid #f4f4f4; background: #fff;
    }
