                            ...
                            <div class="a3">
                                <div class="a3-1">
                                    ...
                                    <div class="right">
                                        ...
                                        <span v-else>
                                            <span class="u2">{{item.workTypeName}}</span><span class="u3" v-show="item.littleBig==0">大工</span>
                                            <span class="u4" v-show="item.littleBig==1">小工</span>
                                         </span>
                                    </div>
                                </div>
                                <div class="a3-2">
    ...
    export default {
        ...
        mounted(){
            wxApi.concatWorkerHistory(this.page, this.pageSize, this.order).then((result)=>{
                ...
                console.log('列表',this.concatWorkerHistory);
            })
        }
    }
</script>
...
<style scoped>
    ...
    .main2 .aul li .bom{
        width: 100%; height: 24px; line-height: 24px; text-align: right; box-sizing: border-box; padding-right: 0.6rem; font-size: 0.6rem; color: #666;
    }
