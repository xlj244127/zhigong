    ...
    <div data-page="downloadList" class="page navbar-fixed toolbar-fixed">
        <div class="navbar">
            <div class="navbar-inner">
                ...
                <div class="center sliding">付费获取积分</div>
            </div>
        </div>
        ...
        methods:{
            ...
            toPay(){
                ...
                if(this.suitId==""){
                    ...
                    wxApi.orderAdd(this.suitId).then((res)=>{
                        ...
                        wxApi.wxPay(that.orderId).then((res)=>{
            ...
            toPayBrand(){
                ...
                wxApi.orderAdd(this.suitId).then((res)=>{
                    ...
                    //        document.addEventListener('WeixinJSBridgeReady', this.toPayBrand(), false);
                    //    }else if (document.attachEvent){
                    //        document.attachEvent('WeixinJSBridgeReady', this.toPayBrand());
                    //        document.attachEvent('onWeixinJSBridgeReady', this.toPayBrand());
                    //    }
                    //}else{
                    //    this.toPayBrand();
                    //}
