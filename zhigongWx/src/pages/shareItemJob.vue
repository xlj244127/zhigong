    ...
    <div data-page="oneRecruit" class="page navbar-fixed">
        ...
        <div class="page-content">
            ...
            <div class="single">
                ...
                <div class="cent">
                    <div class="left"><span v-show="recruitDetail.treatmentsName!=''" v-for="one in recruitDetail.treatmentsName.split(',')">{{one}}</span><span v-show="recruitDetail.tlementName!=''">{{recruitDetail.tlementName}}</span></div>
        ...
        mounted(){
            ...
            wxApi.getConfig(false, this.url).then((result)=> {
                ...
                wx.onMenuShareQQ({
                    ...
                    desc: this.groupOneRecruit.groupName+'招'+this.groupOneRecruit.workTypeName+this.groupOneRecruit.demandAmount+'人,'+this.groupOneRecruit.salary+this.groupOneRecruit.salaryLabel+','+this.groupOneRecruit.treatmentsName, // 分享描述
