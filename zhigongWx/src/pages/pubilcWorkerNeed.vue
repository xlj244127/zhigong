    ...
    export default {
        ...
        methods:{
            ...
            comfigPublic(){
                ...
                console.log("demandType",this.demandType);
                ...
                console.log(this.workGroupId,this.title,this.typecode,this.time,this.demandAmount,this.provinceId,this.cityId,this.districtId,this.detailAddress,this.salaryType,this.salary,this.treatmentCodes.join(','),this.tlementsCode,this.remark,this.demandType);
                if(this.id == 0){
                    wxApi.grouperNeedWork(
                        ...
                        this.workGroupId = result.data.id;  //保存班组id
                        this.$store.state.workGroupId = result.data.id;  //保存班组id
                        this.$router.back();
                })
                }else{
