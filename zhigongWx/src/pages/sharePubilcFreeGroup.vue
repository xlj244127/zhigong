        ...
        <div class="page-content">
            <div class="head">
                <div class="box">
                    ...
                    <input class="right" v-model="name" placeholder="请输入您的姓名（必填）"/>
                </div>
                <div class="box">
    ...
    export default {
        ...
        methods:{
            ...
            publicAction(){
                ...
                console.log(this.name, this.mobile, this.provinceId, this.cityId, JSON.stringify(this.list), this.remark);
                wxApi.sharePublishGroupFee(
                    this.name,
                    this.mobile,
                    this.provinceId,
                    this.cityId,
        ...
        mounted(){
            this.pubilcFreeGroupUpData = [];                                        //每次进页面清空数据
            this.$store.state.pubilcFreeGroupUpData = this.pubilcFreeGroupUpData;
...
<style scoped>
    ...
    .head .box{
        width: 100%; height: 2rem; line-height: 2rem; display: flex; margin-top: 0.8rem; position: relative; box-sizing: border-box; padding-right: 0.6rem;
    }
    .head .box:first-of-type{
        padding-top: 0.5rem; margin-top: 0;
    }
    .head .box .left{
