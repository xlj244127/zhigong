    ...
    <div data-page="editResume" class="page navbar-fixed" @page:reinit="back">
        ...
        <div class="page-content">
            ...
            <div class="freeTime exp">
                ...
                <div class="right-box">
                    <input class="right" v-model="expectTime" @click.stop.prevent="selectTimeAction" id="calendar-defaulttwo" placeholder="请选择预计用工时间" readonly/>
            ...
            <div class="aside">
                ...
                <div class="over">
                    ...
                    <input type="text" placeholder="Describe yourself" readonly id="picker-toolbar_31">
                </div>
            </div>
            <div class="aside">
