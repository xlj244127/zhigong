<template>
    <f7-page name="attendDetail"> <!--固定导航栏-->
        <div class="navbar">
        ...
        <div class="page-content">
            ...
            <div class="cover"  v-if='coverShow' @click="closeCover"></div>
        </div>
    </f7-page>
</template>
...
<script>
    ...
    export default {
        ...
        mounted() {
            console.log('hahaha',this.$store.state.userInfo);
            projectId = this.$route.params.projId;
            groupId = this.$route.params.groupId;
            userId = this.$route.params.userId;
            this.data = this.$route.params.day,
            ...
            this.getAttendDetail(this.data)
